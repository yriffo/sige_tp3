    ...
    public static void mostrarMenu(Scanner scanner) {
        ...
        do {
            ...
            try {
                ...
                switch (opcion) {
                    case 1 -> SIGE.verFichaEstudiante(scanner);
                    case 2 -> SIGE.verBitacoraEstudiante(scanner);
                    case 3 -> SIGE.registrarReunion(scanner);
                    case 4 -> System.out.println("Saliendo del menú Asesor...");
