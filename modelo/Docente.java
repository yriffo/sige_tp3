...
public class Docente extends Usuario {
     ...
     */
    public static void mostrarMenu(Docente docente,Scanner scanner) {
        int opcion;
        do {
            System.out.println("\n--- Menú Docente ---");
            ...
            try {
                ...
                switch (opcion) {
                    case 1 -> SIGE.registrarAsistenciaDocente(docente,scanner);
                    case 2 -> SIGE.verAsistenciasPorCursoYMateria(scanner);
                    case 3 -> SIGE.editarAsistencia(scanner);
                    case 4 -> SIGE.registrarCalificacion(docente);
                    case 5 -> SIGE.verCalificacionesPorCursoYMateria(scanner);
                    case 6 -> SIGE.registrarActividad(docente,scanner);
                    case 7 -> SIGE.verActividadesRegistradas(scanner);
